...
const Unsubscribe = ({
  ...
  return isLoaded ? (
                ...
                <>
                  <Unsubscribe.ProductAll>
                    ...
                    <Unsubscribe.ProdDetails className="product-details">
                      <Unsubscribe.Date className="date">
                        {data.date}
                      </Unsubscribe.Date>
                      <Unsubscribe.ProdDescription className="product-description">
                        {data.product_name}
                      </Unsubscribe.ProdDescription>
                      <Unsubscribe.Price className="price">
                        <Unsubscribe.OldPrice className="old-price">
                          Was: <span>{data.old_price}</span>
                        </Unsubscribe.OldPrice>
                        <Unsubscribe.NewPrice className="new-price">
                          Now: {data.new_price}
                        </Unsubscribe.NewPrice>
                      </Unsubscribe.Price>
    ...
    <ErrorPage link={'unsubscribe'} type={type} />
  );
};
